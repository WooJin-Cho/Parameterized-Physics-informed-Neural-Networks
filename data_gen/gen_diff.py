...
parser.add_argument('--system', type=str, default='diffusion')
...
os.makedirs('./dataset/diffusion/train', exist_ok=True)
os.makedirs('./dataset/diffusion/val', exist_ok=True)
os.makedirs('./dataset/diffusion/test', exist_ok=True)
...
for i in range(41):
    ...
    train_boundary_file_name = './dataset/diffusion/train/train_boundary_' + str(int(nu)) + '_diffusion.csv'
    train_u_file_name        = './dataset/diffusion/train/train_u_' + str(int(nu)) + '_diffusion.csv'
    train_f_file_name        = './dataset/diffusion/train/train_f_' + str(int(nu)) + '_diffusion.csv'
    test_file_name           = './dataset/diffusion/test/test_' + str(int(nu)) + '_diffusion.csv'
    val_file_name            = './dataset/diffusion/val/val_' + str(int(nu)) + '_diffusion.csv'
